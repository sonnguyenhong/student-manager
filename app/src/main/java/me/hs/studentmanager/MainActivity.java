...
//        createTable();
    ...
    public void createTable() {
        ...
        try {
            ...
            db.execSQL("insert into student(full_name, email, dob) values('ngo', 'ngo@gmail.com', '12/12/2021')");
            db.execSQL("insert into student(full_name, email, dob) values('ngo1', 'ngo@gmail.com', '13/12/2021')");
            db.execSQL("insert into student(full_name, email, dob) values('ngo2', 'ngo@gmail.com', '14/12/2021')");
